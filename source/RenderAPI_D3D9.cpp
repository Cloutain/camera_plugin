...
public:
	...
	virtual void ModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int rowPitch, void* dataPtr);
...
void RenderAPI_D3D9::ModifyTexture(void* textureHandle, int textureWidth, int textureHeight, int rowPitch, void* dataPtr)
{
	int textureRowPitch;
	void* textureDataPtr = BeginModifyTexture(textureHandle, textureWidth, textureHeight, &textureRowPitch);
	if (!textureDataPtr)
		return;

	memcpy(textureDataPtr, dataPtr, textureRowPitch*textureHeight);

	EndModifyTexture(textureHandle, textureWidth, textureHeight, textureRowPitch, textureDataPtr);
}
