...
#if OS_ALVA == OS_iOS
#define sem_init_Alva(ptr_sem_t, sem_t_init_value, ptr_char) ptr_sem_t = sem_open(ptr_char, O_CREAT, S_IRWXU, sem_t_init_value)

#define sem_destroy_Alva(ptr_sem_t, ptr_char) sem_close(ptr_sem_t); sem_unlink(ptr_char)
